...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_filename",
        default="focus_on_what_matters_gvc",
        type=str,
        choices=[
            "focus_on_what_matters_mix_2n_ecbplus",
...
# nohup python focus_on_what_matters_mix_2n_ecbplus_pipeline.py --config_filename focus_on_what_matters_mix_2n_ecbplus > ~/code/ecr-code/train_output/nohup_for_focus_mix_2n_ecb.out 2>&1 &
