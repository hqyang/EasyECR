...
nohup sh run.sh 6 easyecr/pipeline/focus_on_what_matters_pipeline.py --config_filename focus_on_what_matters_ecbplus > focus_on_what_matters_ecbplus.log 2>&1 &
...
def get_dataset(
    ...
    debug: bool = False,
    config=None,
    raw_data_cache_dir: str = "/home/nobody/code/ecr-code/focus_on_what_matters_ecbplus_cache",
    train_path: str = "",
    dev_path: str = "",
    test_path: str = "",
    total_path: str = "",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_filename",
        default="focus_on_what_matters_ecbplus",
        type=str,
        choices=[
            "focus_on_what_matters_ecbplus",
            "focus_on_what_matters_fcct",
            "focus_on_what_matters_gvc",
            "focus_on_what_matters_wec",
        ],
    )
    ...
    model: EcrModel = DiscourseCoherenceTheoryEcrModel(
        mode=mode,
...
# nohup python focus_on_what_matters_pipeline.py --config_filename focus_on_what_matters_ecbplus > ~/code/ecr-code/train_output/nohup_for_focus_ecb.out 2>&1 &
# nohup python focus_on_what_matters_pipeline.py --config_filename focus_on_what_matters_gvc > ~/code/ecr-code/train_output/nohup_for_focus_gvc.out 2>&1 &
# nohup python focus_on_what_matters_pipeline.py --config_filename focus_on_what_matters_fcct > ~/code/ecr-code/train_output/nohup_for_focus_fcct.out 2>&1 &
# nohup python focus_on_what_matters_pipeline.py --config_filename focus_on_what_matters_wec > ~/code/ecr-code/train_output/nohup_for_focus_wec.out 2>&1 &
