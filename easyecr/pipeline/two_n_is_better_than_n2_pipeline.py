...
nohup sh run.sh 0 easyecr/pipeline/two_n_is_better_than_n2_pipeline.py --config_filename two_n_is_better_than_n2_ecbplus > two_n_is_better_than_n2_ecbplus.log 2>&1 &
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_filename",
        default="two_n_is_better_than_n2_ecbplus",
        type=str,
        choices=[
            "two_n_is_better_than_n2_ecbplus_first2sentece",
            "two_n_is_better_than_n2_ecbplus_sentence",
            "two_n_is_better_than_n2_ecbplus",
            "two_n_is_better_than_n2_fcct",
            "two_n_is_better_than_n2_gvc",
            "two_n_is_better_than_n2_wec",
        ],
    )
    ...
    model: EcrModel = LemmaDistanceEcrModel(
        mode=mode,
...
# nohup python two_n_is_better_than_n2_pipeline.py --config_filename two_n_is_better_than_n2_wec > ~/code/ecr-code/train_output/nohup_for_2n_wec.out 2>&1 &
# nohup python two_n_is_better_than_n2_pipeline.py --config_filename two_n_is_better_than_n2_gvc > ~/code/ecr-code/train_output/nohup_for_2n_gvc.out 2>&1 &
# nohup python two_n_is_better_than_n2_pipeline.py --config_filename two_n_is_better_than_n2_ecbplus > ~/code/ecr-code/train_output/nohup_for_2n_ecbplus.out 2>&1 &
# nohup python two_n_is_better_than_n2_pipeline.py --config_filename two_n_is_better_than_n2_ecbplus_sentence > ~/code/ecr-code/train_output/nohup_for_2n_sentence_ecbplus.out 2>&1 &
# nohup python two_n_is_better_than_n2_pipeline.py --config_filename two_n_is_better_than_n2_ecbplus_first2sentece > ~/code/ecr-code/train_output/nohup_for_2n_first2sentece_ecbplus.out 2>&1 &
# nohup python two_n_is_better_than_n2_pipeline.py --config_filename two_n_is_better_than_n2_fcct > ~/code/ecr-code/train_output/nohup_for_2n_fcct.out 2>&1 &
