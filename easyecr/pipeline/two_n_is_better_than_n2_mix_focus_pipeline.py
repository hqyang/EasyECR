...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_filename",
        default="two_n_is_better_than_n2_mix_focus_ecbplus",
        type=str,
        choices=[
            "two_n_is_better_than_n2_mix_focus_ecbplus",
...
# nohup python two_n_is_better_than_n2_mix_focus_pipeline.py --config_filename two_n_is_better_than_n2_mix_focus_ecbplus > ~/code/ecr-code/train_output/nohup_for_2n_mix_focus_ecb.out 2>&1 &
