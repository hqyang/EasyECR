...
def get_dataset(
    ...
    if (
        ...
        print(metrics)
        tagger: EcrTagger = ContextualizedRepresentationTagger(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_filename",
        default="lemma_distance_end_to_end_ecbplus",
        type=str,
        choices=["lemma_distance_end_to_end_ecbplus"],
    )
...
# nohup python lemma_distance_end_to_end_pipeline.py --config_filename lemma_distance_end_to_end_ecbplus > ~/code/ecr-code/train_output/nohup_for_lemma_e2e.out 2>&1 &
