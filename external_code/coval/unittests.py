...
from external_code.coval.coval.conll.reader import get_coref_infos
from external_code.coval.coval.eval.evaluator import evaluate_documents as evaluate
from external_code.coval.coval.eval.evaluator import muc, b_cubed, ceafe, lea
